...
# Test Scripts: buffer, array, disk, hash, recent, thread

all: test array buffer thread disk hash recent
...
test:
	...
	./generator --puts=500000 --gets=500000 --gaussian-ranges > text2.txt
	cat text2.txt | grep p > put2.txt
	cat text2.txt | grep g > get2.txt 
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.0.txt
	cat text3.txt | grep g > get0.0.txt 
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0.1 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.1.txt
	cat text3.txt | grep g > get0.1.txt 
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0.2 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.2.txt
	cat text3.txt | grep g > get0.2.txt 
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0.3 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.3.txt
	cat text3.txt | grep g > get0.3.txt 
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0.4 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.4.txt
	cat text3.txt | grep g > get0.4.txt
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0.5 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.5.txt
	cat text3.txt | grep g > get0.5.txt
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0.6 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.6.txt
	cat text3.txt | grep g > get0.6.txt
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0.7 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.7.txt
	cat text3.txt | grep g > get0.7.txt
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0.8 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.8.txt
	cat text3.txt | grep g > get0.8.txt 
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 0.9 --gaussian-ranges > text3.txt
	cat text3.txt | grep p > put0.9.txt
	cat text3.txt | grep g > get0.9.txt 
	./generator --puts=500000 --gets=500000 --gets-misses-ratio 1.0 --gaussian-ranges > text3.txt
...
hash: db-ht.cpp
	g++ -DHASS_SHIFT=5 -DRECENT -o hash_5 db-ht.cpp -pthread
	g++ -DHASS_SHIFT=6 -DRECENT -o hash_6 db-ht.cpp -pthread
	...
	g++ -DHASS_SHIFT=11 -DRECENT -o hash_11 db-ht.cpp -pthread
	g++ -DHASS_SHIFT=12 -DRECENT -o hash_12 db-ht.cpp -pthread
	g++ -DHASS_SHIFT=13 -DRECENT -o hash_13 db-ht.cpp -pthread
recent: db-ht.cpp
	g++ -DTHREAD_NUM=64 -DRECENT -o recent_yes db-ht.cpp -pthread
	g++ -DTHREAD_NUM=64 -o recent_no db-ht.cpp -pthread

.PHONY:
clean:
	rm -f buffer_* thread_* hash_* disk_* recent_* array_*
